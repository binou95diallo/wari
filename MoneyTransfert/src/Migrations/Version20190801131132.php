 ...
 */
final class Version20190801131132 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_8D93D64912CB990C ON user (bank_account_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_8D93D64912CB990C ON user');
    }
}
